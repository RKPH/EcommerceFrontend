...
export function Register() {
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(registerUser({ name, email, password })); // Dispatch the registration action
    };
        ...
        >
          ...
          Join Sport Ecommerce
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur-md rounded-lg p-8 shadow-lg max-w-md w-full">
                <h3 className="text-3xl text-blue-gray-800 mb-2 text-center">Sign Up</h3>
                <p className="mb-16 text-gray-600 text-center text-lg">
                    Create your account to explore amazing products!
                </p>
                <form onSubmit={handleSubmit} className="mx-auto max-w-md text-left">
                    ...
                    <div className="mt-4 flex justify-between">
                        <Link to="/login" className="text-black-600 hover:text-gray-400 font-medium">
